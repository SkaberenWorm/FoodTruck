...
if ( current_user_can( 'edit_theme_options' ) ) {
	$default = esc_html__( 'Latest products', 'shop-isle' );
}
...
if ( function_exists( 'wc_get_page_id' ) ) {
	echo '<a href="' . esc_url( get_permalink( wc_get_page_id( 'shop' ) ) ) . '" class="btn btn-b btn-round">' . apply_filters( 'shop_isle_see_all_products_label', __( 'Ver todos los productos', 'shop-isle' ) ) . '</a>';
} elseif ( function_exists( 'woocommerce_get_page_id' ) ) {
	echo '<a href="' . esc_url( get_permalink( woocommerce_get_page_id( 'shop' ) ) ) . '" class="btn btn-b btn-round">' . apply_filters( 'shop_isle_see_all_products_label', __( 'Ver todos los productos', 'shop-isle' ) ) . '</a>';
}
echo '</div>';
echo '</div>';
